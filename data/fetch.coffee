...
restricted = ["Director Haas' Pet Project", "Philotic Entanglement", "Eden Shard", "Eden Fragment", "Hades Shard", "Hades Fragment", "Uptopia Shard", "Uptopia Fragment", "Government Takeover"]
