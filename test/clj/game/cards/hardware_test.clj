...
(deftest mind-s-eye
  ...
  (testing "Interaction with RDI + Aeneas"
    (do-game
      ...
      (take-credits state :corp)
      (gain state :runner :credit 10 :click 20)
...
(deftest obelus
  ...
  (testing "Basic test"
    (do-game
      ...
      (take-credits state :corp)
      (gain state :runner :credit 10 :click 3)
