...
(deftest attitude-adjustment
  ...
  (do-game
    ...
    (let [credits (-> (get-corp) :credit)
      ...
      (prompt-select :corp (find-card "Hostile Takeover" (:hand (get-corp))))
...
(deftest fast-break
  ...
  (do-game
    ...
    (let [hand (-> (get-corp) :hand count)
      ...
      (prompt-choice :corp "New remote")
      (prompt-select :corp (find-card "Keegan Lane" (:hand (get-corp))))
      (prompt-select :corp (find-card "Ice Wall" (:hand (get-corp))))
      (prompt-select :corp (find-card "Ice Wall" (:hand (get-corp))))
    ...
    (let [hand (-> (get-corp) :hand count)
      ...
      (prompt-select :corp (find-card "Haas Arcology AI" (:hand (get-corp))))
      (prompt-select :corp (find-card "Research Station" (:hand (get-corp))))
