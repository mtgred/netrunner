...
(deftest ^:test-refresh/focus inside-job
  ;; Inside Job
  (do-game
    (new-game {:corp {:deck [(qty "Hedge Fund" 5)]}
...
(deftest levy-ar-lab-access
  ...
  (do-game
    (new-game {:corp {:deck [(qty "Hedge Fund" 5)]}
               :runner {:hand ["Levy AR Lab Access"]}})
    ))
...
(deftest process-automation
  ...
  (do-game
    (new-game {:corp {:deck [(qty "Hedge Fund" 5)]}
               :runner {:hand ["Process Automation"]}})
    ))
