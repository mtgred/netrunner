...
(deftest log-accessed-names
  ...
  (do-game
    ...
    (take-credits state :corp)
    (run-empty-server state :hq)
    (prompt-choice state :runner "No") ; Dismiss trash prompt
...
(deftest multi-steal-archives
  ...
  (do-game
    ...
    (prompt-choice state :runner "Breaking News")
    (prompt-choice state :runner "Steal")
    (prompt-choice state :runner "Breaking News")
    (prompt-choice state :runner "Steal")
    (prompt-choice state :runner "Breaking News")
