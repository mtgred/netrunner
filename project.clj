(defproject netrunner "1.0"
  ...
  :cljsbuild {
    :builds [
      {:id "dev"
       :source-paths ["src/clj/game/core" "src/cljs/nr" "src/cljs/nr/gameboard" "src/cljs/dev" "src/cljc"]
       :figwheel true
      ...
      {:id "prod"
       :source-paths ["src/cljs/nr" "src/cljs/nr/gameboard" "src/cljs/prod" "src/cljc"]
