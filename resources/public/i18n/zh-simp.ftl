...
set_napd-multiplayer = NAPD 多人
set_ntscape-navigator-alt-arts = Ntscape Navigator 异画
set_old-hollywood = 老莱坞
set_opening-moves = 起手开局
set_order-and-chaos = 秩序与混沌
set_parhelion = 幻日
set_plural-and-miniplural-alt-arts = Plural and MiniPlural 异画
