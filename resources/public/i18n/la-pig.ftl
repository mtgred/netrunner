...
deck-builder_games = Amesgay: {$games}
...
deck-builder_won = Onway: {$won} ({NUMBER($percent, style: "percent")})
...
stats_completed = Ompletedcay: {$completed} ({NUMBER($percent, style: "percent")})
...
stats_lost = Ostlay: {$lost} ({NUMBER($percent, style: "percent")})
stats_no-games = Onay amesgay
stats_no-log = Onay oglay availableyay
stats_not-completed = Otnay ompletedcay: {$completed} ({NUMBER($percent, style: "percent")})
...
stats_started = Artedstay: {$started}
