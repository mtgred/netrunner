...
(def translations
  {:missing ":ru missing text"
   ...
   :format {:all "Все"
            ...
            :startup "Стартап"}
   :preconstructed {:worlds-2012-a "ЧМ 2012: Ben Marsh (C) vs. Jeremy Zwirn (R)"
                    :worlds-2012-a-tag "Ben Marsh (C) vs. Jeremy Zwirn (R)"
                    :worlds-2012-a-ul "ЧМ 2012: Weyland vs. Criminal"
                    :worlds-2012-b "ЧМ 2012: Jeremy Zwirn (C) vs. Ben Marsh (R)"
                    :worlds-2012-b-tag "Jeremy Zwirn (C) vs. Ben Marsh (R)"
                    :worlds-2012-b-ul "ЧМ 2012: Haas-Bioroid vs. Criminal"
                    :worlds-2012-info "ЧМ 2012 was played with (up to 3 copies of) the Core Set as the only legal product. Jeremy Zwirn (Building a Better World, Gabriel Santiago) took first place against Ben Marsh (Engineering the Future, Gabriel Santiago) in the first ever Netrunner World Championship."
                    :worlds-2013-a "ЧМ 2013: Jens Erickson (C) vs. Andrew Veen (R)"
                    :worlds-2013-a-tag "Jens Erickson (C) vs. Andrew Veen (R)"
                    :worlds-2013-a-ul "ЧМ 2013: HB FastAdv vs. Shaper Katman"
                    :worlds-2013-b "ЧМ 2013: Andrew Veen (C) vs. Jens Erickson (R)"
                    :worlds-2013-b-tag "Andrew Veen (C) vs. Jens Erickson (R)"
                    :worlds-2013-b-ul "ЧМ 2013: NBN Fast Adv vs. Andy Sucker"
                    ...
                    :worlds-2014-a "ЧМ 2014: Dan D'Argenio (C) vs. Minh Tran (R)"
                    :worlds-2014-a-tag "Dan D'Argenio (C) vs. Minh Tran (R)"
                    :worlds-2014-a-ul "ЧМ 2014: Honor and Perfection vs. Andromedium"
                    :worlds-2014-b "ЧМ 2014: Minh Tran (C) vs. Dan D'Argenio (R)"
                    :worlds-2014-b-tag "Minh Tran (C) vs. Dan D'Argenio (R)"
                    :worlds-2014-b-ul "ЧМ 2014: Personal Evolution vs. Daily QT Andy"
                    ...
                    :worlds-2015-a "ЧМ 2015: Dan D'Argenio (C) vs. Timmy Wong (R)"
                    :worlds-2015-a-tag "Dan D'Argenio (C) vs. Timmy Wong (R)"
                    :worlds-2015-a-ul "ЧМ 2015: Foodcoatshop vs. The Morning After"
                    :worlds-2015-b "ЧМ 2015: Timmy Wong (C) vs. Dan D'Argenio (R)"
                    :worlds-2015-b-tag "Dan D'Argenio (C) vs. Timmy Wong (R)"
                    :worlds-2015-b-ul "ЧМ 2015: Yellow Shell vs. Radisson Cheese Plate"
                    ...
                    :worlds-2016-a "ЧМ 2016: Chris Dyer (C) vs. Benjamin Ni (R)"
                    :worlds-2016-a-tag "Chris Dyer (C) vs. Benjamin Ni (R)"
                    :worlds-2016-a-ul "ЧМ 2016: Snekbite vs. Minh MaxX++"
                    :worlds-2016-b "ЧМ 2016: Benjamin Ni (R) vs. Chris Dyer (C)"
                    :worlds-2016-b-tag "Benjamin Ni (R) vs. Chris Dyer (C)"
                    :worlds-2016-b-ul "ЧМ 2016: Fiery Info vs. Papa Smurf"
                    ...
                    :worlds-2017-a "ЧМ 2017: Jess Horig (C) vs. Grey Tongue (R)"
                    :worlds-2017-a-tag "Jess Horig (C) vs. Grey Tongue (R)"
                    :worlds-2017-a-ul "ЧМ 2017: Stinson Reversed CI vs. Aesops Hayley"
                    :worlds-2017-b "ЧМ 2017: Grey Tongue (C) vs. Jess Horig (R)"
                    :worlds-2017-b-tag "Grey Tongue (C) vs. Jess Horig (R)"
                    :worlds-2017-b-ul "ЧМ 2017: No-Show Rewiring CI vs. Laguna Lock Hayley"
                    ...
                    :worlds-2018-a "ЧМ 2018: Joe Schupp (C) vs. Chris Dyer (R)"
                    :worlds-2018-a-tag "Joe Schupp (C) vs. Chris Dyer (R)"
                    :worlds-2018-a-ul "ЧМ 2018: AMERICA CtM vs. Gooseberry MaxX"
                    :worlds-2018-b "ЧМ 2018: Chris Dyer (C) vs. Joe Schupp (R)"
                    :worlds-2018-b-tag "Chris Dyer (C) vs. Joe Schupp (R)"
                    :worlds-2018-b-ul "ЧМ 2018: Trust the Process vs. Dan D'Argenio KoS Val"
                    ...
                    :worlds-2019-a "ЧМ 2019: Pinsel (C) vs. Testrunning (R)"
                    :worlds-2019-a-tag "Pinsel (C) vs. Testrunning (R)"
                    :worlds-2019-a-ul "ЧМ 2019: Fully dedicated to efficiency vs. Trash Panda"
                    :worlds-2019-b "ЧМ 2019: Testrunning (C) vs. Pinsel (R)"
                    :worlds-2019-b-tag "Testrunning (C) vs. Pinsel (R)"
                    :worlds-2019-b-ul "ЧМ 2019: 2 Grid for 2 Place vs. Trash Panda"
                    ...
                    :worlds-2020-a "ЧМ 2020: Limes (C) vs. tf34 (R)"
                    :worlds-2020-a-tag "Limes (C) vs. tf34 (R)"
                    :worlds-2020-a-ul "ЧМ 2020: I don't like this deck vs. Engolo Freedom"
                    :worlds-2020-b "ЧМ 2020: tf34 (R) vs. Limes (C)"
                    :worlds-2020-b-tag "tf34 (R) vs. Limes (C)"
                    :worlds-2020-b-ul "ЧМ 2020: Malia CTM vs. Imp-pressive Hoshiko"
                    ...
                    :worlds-2021-a "ЧМ 2021: Patrick Gower (C) vs. Jonas (R)"
                    :worlds-2021-a-tag "Patrick Gower (C) vs. Jonas (R)"
                    :worlds-2021-a-ul "ЧМ 2021: 44 Card PD vs. Watch Me Drip, Watch Me Maemi"
                    :worlds-2021-b "ЧМ 2021: Jonas (C) vs. Patrick Gower (R)"
                    :worlds-2021-b-tag "Jonas (C) vs. Patrick Gower (R)"
                    :worlds-2021-b-ul "ЧМ 2021: Is Gagarin Good? vs. Medium to Large Maxx"
                    ...
                    :worlds-2022-a "ЧМ 2022: William Huang (C) vs. skry (R)"
                    :worlds-2022-a-tag "William Huang (C) vs. skry (R)"
                    :worlds-2022-a-ul "ЧМ 2022: SNACS vs. Liberté, Égalité, Humidité"
                    :worlds-2022-b "ЧМ 2022: skry (C) vs. William Huang (R)"
                    :worlds-2022-b-tag "skry (C) vs. William Huang (R)"
                    :worlds-2022-b-ul "ЧМ 2022: Dies to Doom Blade vs. ApocoLat"
                    ...
                    :worlds-2023-a "ЧМ 2023: William Huang (C) vs. cableCarnage (R)"
                    :worlds-2023-a-tag "William Huang (C) vs. cableCarnage (R)"
                    :worlds-2023-a-ul "ЧМ 2023: The Worlds Grind vs. sableCarnage"
                    :worlds-2023-b "ЧМ 2023: cableCarnage (C) vs. William Huang (R)"
                    :worlds-2023-b-tag "cableCarnage (C) vs. William Huang (R)"
                    :worlds-2023-b-ul "ЧМ 2023: tableCarnage vs. You *do* always come back!"
