...
(declare can-trigger? event-title get-card get-remote-names get-runnable-zones get-zones register-suppress resolve-ability trigger-suppress unregister-suppress)
