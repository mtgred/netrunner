...
(declare forfeit damage mill installed? is-type? is-scored? system-msg facedown? unknown->kw discard-from-hand card-str trash trash-cards all-installed-runner-type)
