(ns game.cards.ice
  (:require
   ...
   [game.core.card :refer [active? agenda? asset? can-be-advanced? card-index
                           ...
                           program? protecting-a-central? protecting-hq? resource? rezzed? runner?]]
   ...
   [game.core.flags :refer [can-rez? prevent-draw prevent-jack-out
                            register-run-flag! register-turn-flag! zone-locked?]]
   [game.core.gaining :refer [gain-credits lose-clicks lose-credits]]
   [game.core.hand-size :refer [hand-size]]
   [game.core.hosting :refer [host]]
   [game.core.ice :refer [add-sub add-sub! break-sub pump-all-ice remove-sub!
                          remove-subs! resolve-subroutine set-current-ice
