(ns game.cards.upgrades
  (:require
   ...
   [game.core.card :refer [agenda? asset? corp-installable-type? corp?
                           get-card get-counters get-zone has-subtype? ice?
                           in-discard? in-hand? installed? operation? program? resource? rezzed? runner? upgrade?]]
