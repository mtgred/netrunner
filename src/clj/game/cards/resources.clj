(ns game.cards.resources
  (:require
   ...
   [game.core.access :refer [access-bonus access-n-cards breach-server steal steal-cost-bonus]]
   ...
   [game.core.card :refer [agenda? asset? assoc-host-zones card-index corp?
                           ...
                           installed? is-type? program? resource? rezzed? runner? upgrade?]]
   ...
   [game.core.engine :refer [not-used-once? pay prompt! register-events
                             ...
                             trigger-event trigger-event-sync unregister-suppress-by-uuid]]
   ...
   [game.core.flags :refer [card-flag? clear-persistent-flag! has-flag?
                            ...
                            register-turn-flag! zone-locked?]]
