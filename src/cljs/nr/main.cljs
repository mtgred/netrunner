(ns nr.main
  (:require [goog.events :as events]
            ...
            [nr.gameboard :refer [concede mute-spectators]]
...
(defn mount-root []
  ...
  (r/render [chat] (. js/document (getElementById "chat")))
  ;(r/render [help] (.getElementById js/document "help"))
  (r/render [deck-builder @app-state] (.getElementById js/document "deckbuilder"))
  (r/render [game-lobby @app-state] (. js/document (getElementById "gamelobby")))
  (r/render [news] (.getElementById js/document "news"))
  (r/render [stats (r/cursor app-state [:stats])] (.getElementById js/document "stats"))
