...
(def translation-dictionary
  ...
  :fr
   {:missing ":fr texte manquant"
    ...
    {:search-hint "Rechercher des cartes"
     ...
     :type "Type"
     :clear "Effacer"
     :select-art "Selectionner l'art"
     :selected-art "Selectionner l'art alternatif"
     :update-success "Art mis à jour"
     :update-failure "Echec de la mise à jour de l'art"
     :memory "Mémoire"
     :cost "Coût"
     :trash-cost "Coût d'effacement"
     :strength "Force"
     ...
     :sort-by {:faction "Faction"
              ...
              :influence "Influence"
              :cost "Coût"
              :set-number "Numéro de l'ensemble"}
     }
    :deck-builder
    {:loading-msg "Chargement de la collection de decks..."
     :new-corp "Nouveau Corpo"
     :new-runner "Nouveau Runner"
     ...
     :decklist "Decklist"
     :decklist-inst "(Saisissez ou copier une decklist, elle sera analysée)"
     :notes "Notes"
     :add-to-deck "Ajouter au deck"
     :add-cards "Ajouter cartes"
   ...
   :lobby
    {:no-games "Pas de partie"
     ...
     :waiting "En attente de la sélection de deck des joueurs"
     :players "Joueurs"
     :deck-selected "Deck selectionné"
     :select-deck "Selectionner un deck"
     :chat "Discuter"
     :select-title "Selectionner votre deck"
     :spectator-count (fn [[cnt]] (str cnt " Spectateur" (when (not= cnt 1) "s")))
     :closed-msg "Lobby de la partie fermé pour cause d'inactivité"
     ...
     :completion-rate "Taux d'achèvement de la partie"
     :watch "Regarder"
     :join "Joindre"
     :rejoin "Rejoindre"
     :as-corp "Comme Corpo"
     :as-runner "Comme Runner"
     :private "PRIVEE"
     ...
     :filtered "(filtré)"}
   :settings
   {:invalid-password "Login ou mot de passe invalide"
    :invalid-email "Aucun compte avec cette adresse e-mail"
    :updated "Profil mise à jour - Veuillez actualiser votre navigateur"
    ...
    :language "Langue"
    :sounds "Sons"
    :enable-lobby-sounds "Activer les sons du lobby"
    :enable-game-sounds "Activer les sons du jeu"
    :volume "Volume"
    :layout-options "Options de disposition"
    :stacked-cards "Empilement de cartes (activé par défaut)"
    ...
    :background "Arrière plan du plateau de jeu"
    :card-backs "Dos des cartes"
    :game-stats "Statistiques des matchs gagnants/perdants"
    :deck-stats "Statistiques de deck"
    :always "Toujours"
    :comp-only "Lobby compétitif uniquement"
    :none "Aucun"
    :alt-art "Arts alternatifs"
    :show-alt "Afficher les arts de carte alternatifs"
    :high-res "Activer les images hautes résolution des cartes"
  ...
  {:game-stats "Statistiques de jeu"
   ...
   :credits-gained "Credits gagnés"
   :credits-spent "Credits dépensés"
   :credits-click "Credits par clic"
   :cards-drawn "Cartes piochées"
   :cards-click "Cards tirées par clic"
   :damage-done "Dégats infligés"
   :cards-rezzed "Cartes activées"
   :tags-gained "Tags obtenus"
   :runs-made "Piratages réalisés"
   :cards-accessed "Cartes accédées"}
  :log
  {:game-log "Journal de jeu"
   :annotating "Annoter"
  ...
  {:keep "Garder"
   ...
   :mu-count (fn [[unused available]] (str unused " of " available " UM inutilisée(s)"))
   :special-mu-count (fn [[unused available mu-type]] (str unused " of " available " " mu-type " UM inutilisée(s)"))
   ...
   :unstack-cards "Dépiler les cartes"
   :stack-cards "Empiler les cartes"
   :unmute "Réactiver le son des spectateurs"
   :mute "Faire taire les spectateurs"
   :concede "Conceder"
   :inactivity "Partie terminée pour cause d'inactivé"
   :server "Serveur"
   :unimplemented "Non implementé"
   :abilities "Capacités"
   :let-subs-fire "Laisser se déclencher les routines non neutralisées"
   :subs "Routines"
   :actions "Actions"
   ...
   :breach-server "Atteindre le serveur"
   :success "Succès"
   ...
   :rez "Activer"
   :action-access "Action avant accès"
   :no-further "Aucune autre action"
   :continue "Continuer"
   :continue-to "Continuer à"
   :stop-auto-pass "Stop auto-passing priority"
   :auto-pass "Auto-pass priority"
   :jack-out "Débrancher"
   :undo-click "Annuler clic"
   ...
   :win-decked (fn [[turn]] (str "gagne par Corpo à cours de deck au tour " turn))
